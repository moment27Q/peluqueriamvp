...
export declare class ServiceRecordService {
    ...
    static getServiceById(id: string, tenantId?: string): Promise<ServiceWithDetails>;
    static updateService(id: string, input: UpdateServiceInput, updatedBy: string, tenantId?: string): Promise<ServiceWithDetails>;
    static deleteService(id: string, deletedBy: string, tenantId?: string): Promise<void>;
    ...
    static getAllServiceTypes(includeInactive?: boolean, tenantId?: string): Promise<{
        id: string;
        tenantId: string;
        isActive: boolean;
        createdAt: Date;
    ...
    static updateServiceType(id: string, input: UpdateServiceTypeInput, tenantId?: string): Promise<{
        id: string;
        tenantId: string;
        isActive: boolean;
        createdAt: Date;
    ...
    static deleteServiceType(id: string, tenantId?: string): Promise<void>;
}
